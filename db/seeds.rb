...
Location.real.each { |location| mudclub.locations << location }
sport = Sport.first
...
Team.create(name: "U18 male", season_id: 1, category_id: 4, division_id: 2, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U18 female", season_id: 1, category_id: 4, division_id: 2, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U16 female", season_id: 1, category_id: 5, division_id: 2, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U16 male", season_id: 1, category_id: 6, division_id: 2, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U14 female", season_id: 1, category_id: 7, division_id: 2, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U14 male", season_id: 1, category_id: 8, division_id: 2, homecourt_id: 2, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U12 male", season_id: 1, category_id: 9, division_id: 1, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U12 female", season_id: 1, category_id: 10, division_id: 1, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "U10 mixed", season_id: 1, category_id: 14, division_id: 1, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)
Team.create(name: "Baby Basket", season_id: 1, category_id: 15, division_id: 1, homecourt_id: 1, sport_id: sport.id, club_id: mudclub.id)