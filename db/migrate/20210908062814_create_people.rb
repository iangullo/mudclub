class CreatePeople < ActiveRecord::Migration[6.1]
  def change
    ...
    ActiveRecord::Base.connection.execute("INSERT INTO people (id, dni, name, surname, birthday, female, email, phone, created_at, updated_at) values (0,'00000000A','Nueva','Persona','2021-09-01',TRUE,'fake@mudclub.org','+34 666666666','2021-09-13 08:12','2021-09-13 08:12')")
