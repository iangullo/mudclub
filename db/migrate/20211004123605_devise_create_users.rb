...
class DeviseCreateUsers < ActiveRecord::Migration[6.1]
  def change
    ...
    ActiveRecord::Base.connection.execute("INSERT INTO users (id, email, person_id, role, created_at, updated_at) values (1,'admin@mudclub.org',1,4,'2021-09-13 08:12','2021-09-13 08:12')")
    admin = User.last
